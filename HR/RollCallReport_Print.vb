...
Public Class RollCallReport_Print
    ...
    Private Sub pd_PrintMain(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        While X < DGV1.Rows.Count And RowsHeigth < PageHeight
            ...
            If X = 0 Or DGV1.Rows(X).Cells("员工工号").Value <> DGV1.Rows(X - IntTemp).Cells("员工工号").Value Then
                ...
                e.Graphics.DrawString("出勤日期：" & TotalA2, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.7, RowsHeigth, PageWidth * 0.4, DGV1.Rows(0).Height), drawFormatC)
                ...
                e.Graphics.DrawString("日期", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height * 1.5), drawFormat)
                ...
                e.Graphics.DrawString("班次", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.145, RowsHeigth, PageWidth * 0.15, DGV1.Rows(0).Height * 1.5), drawFormatC)
                e.Graphics.DrawString("上班", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.205, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height * 1.5), drawFormat)
                e.Graphics.DrawString("外出", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.265, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height * 1.5), drawFormat)
                e.Graphics.DrawString("返回", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.325, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height * 1.5), drawFormat)
                e.Graphics.DrawString("下班", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.385, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height * 1.5), drawFormat)
                e.Graphics.DrawString("上班2", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.445, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height * 1.5), drawFormat)
                e.Graphics.DrawString("下班2", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.505, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height * 1.5), drawFormat)
                e.Graphics.DrawString("津贴", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.565, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height * 1.5), drawFormatC)
                e.Graphics.DrawString("实到" & vbCrLf & "工时", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.6, RowsHeigth, PageWidth * 0.05, DGV1.Rows(0).Height * 1.5), drawFormat)
                e.Graphics.DrawString("平日" & vbCrLf & "加班", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.65, RowsHeigth, PageWidth * 0.05, DGV1.Rows(0).Height * 1.5), drawFormat)
                ...
                e.Graphics.DrawString("工作" & vbCrLf & "时数", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.8 + 10, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height * 1.5), drawFormat)
                e.Graphics.DrawString("请假", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.86 + 30, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height * 1.5), drawFormat)
                e.Graphics.DrawString("时间", PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.92 + 40, RowsHeigth, PageWidth * 0.05, DGV1.Rows(0).Height * 1.5), drawFormat)
            ...
            e.Graphics.DrawString(Mid(DGV1.Rows(X).Cells("日期").Value, 6), PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left, RowsHeigth, PageWidth * 0.06, DGV1.Rows(0).Height), drawFormat)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("星期").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.06, RowsHeigth, PageWidth * 0.02, DGV1.Rows(0).Height), drawFormat)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("节假日").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.08, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height), drawFormatC)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("班次").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.145, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height), drawFormatC)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("第1次").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.205, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height), drawFormat)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("第2次").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.265, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height), drawFormat)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("第3次").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.325, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height), drawFormat)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("第4次").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.385, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height), drawFormat)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("第5次").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.445, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height), drawFormat)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("第6次").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.505, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height), drawFormat)
            e.Graphics.DrawString(DGV1.Rows(X).Cells("津贴").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.565, RowsHeigth, PageWidth * 0.065, DGV1.Rows(0).Height), drawFormatC)
            ...
            e.Graphics.DrawString(DGV1.Rows(X).Cells("请假").Value, PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.86 + 25, RowsHeigth, PageWidth * 0.09, DGV1.Rows(0).Height), drawFormatC)

            If InStr(DGV1.Rows(X).Cells("请假").Value, "迟到") > 0 Or InStr(DGV1.Rows(X).Cells("请假").Value, "早退") > 0 Then
                e.Graphics.DrawString(Format(DGV1.Rows(X).Cells("迟到").Value, "#,##0;-#,##0; "), PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.92 + 30, RowsHeigth, PageWidth * 0.05, DGV1.Rows(0).Height), drawFormatB)
            Else
                e.Graphics.DrawString(Format(DGV1.Rows(X).Cells("时间").Value, "#,##0.0;-#,##0.0; "), PrintFont, System.Drawing.Brushes.Black, New RectangleF(e.MarginBounds.Left + PageWidth * 0.92 + 30, RowsHeigth, PageWidth * 0.05, DGV1.Rows(0).Height), drawFormatB)
            End If
